...
class Turtlebot {
    ...
    analysisRosMessage(message){
        ...
        else if(this.isDataContainKeyword(receivedData,'finger_detection:true')){
            this.isFingerDetection = true;
        }
        else if(this.isDataContainKeyword(receivedData,'finger_detection:false')){
            this.isFingerDetection = false;
        }
...
class Scratch3TurtleBotBlocks {
    ...
    subFingers_detection (args) {
        return this.turtlebot_.isFingerDetection;
    }
    ...
    getInfo () {
        return {
            ...
            blocks: [
                ...
                {
                    opcode: 'subFingers_detection',
                    text: formatMessage({ id: 'turtlebot.subFingers_detection', default: '人差し指を立てている' }),
                    blockType: BlockType.BOOLEAN,
                    arguments: {}
                }
            ],
