...
class Scratch3TurtleBotBlocks {
    ...
    pubRecognition_time (args) {
        this.turtlebot_.publishScratchRos("recognition_time:"+String(args.TIME))
    }
        ...
        return {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    blockType: BlockType.COMMAND,
                    arguments: {RECOGNITION_TIME:{type: ArgumentType.STRING, defaultValue:formatMessage({id:'turtlebot.recognition_time',　default:'5'})}}
                },
                {
