...
class Turtlebot {
    ...
    constructor(){
        ...
        this.isFingerDetection0 = false;
        this.isFingerDetection1 = false;
        this.isFingerDetection2 = false;
        this.isFingerDetection3 = false;
        this.isFingerDetection4 = false;
    }
    ...
    analysisRosMessage(message){
        ...
        else if(this.isDataContainKeyword(receivedData,'finger_detection0:true')){
            this.isFingerDetection0 = true;
        }
        else if(this.isDataContainKeyword(receivedData,'finger_detection0:false')){
            this.isFingerDetection0 = false;
        }
        else if(this.isDataContainKeyword(receivedData,'finger_detection1:true')){
            this.isFingerDetection1 = true;
        }
        else if(this.isDataContainKeyword(receivedData,'finger_detection1:false')){
            this.isFingerDetection1 = false;
        }
        else if(this.isDataContainKeyword(receivedData,'finger_detection2:true')){
            this.isFingerDetection2 = true;
        }
        else if(this.isDataContainKeyword(receivedData,'finger_detection2:false')){
            this.isFingerDetection2 = false;
        }
        else if(this.isDataContainKeyword(receivedData,'finger_detection3:true')){
            this.isFingerDetection3 = true;
        }
        else if(this.isDataContainKeyword(receivedData,'finger_detection3:false')){
            this.isFingerDetection3 = false;
        }
        else if(this.isDataContainKeyword(receivedData,'finger_detection4:true')){
            this.isFingerDetection4 = true;
        }
        else if(this.isDataContainKeyword(receivedData,'finger_detection4:false')){
            this.isFingerDetection4 = false;
        }
...
class Scratch3TurtleBotBlocks {
    ...
    pubRecognition_time (args) {
        this.turtlebot_.publishScratchRos("recognition_time:"+String(args.RECOGNITION_TIME))
  	}
    ...
    subFingers_detection0 (args) {
        return this.turtlebot_.isFingerDetection0;
    }

    subFingers_detection1 (args) {
        return this.turtlebot_.isFingerDetection1;
    }

    subFingers_detection2 (args) {
        return this.turtlebot_.isFingerDetection2;
    }

    subFingers_detection3 (args) {
        return this.turtlebot_.isFingerDetection3;
    }

    subFingers_detection4 (args) {
        return this.turtlebot_.isFingerDetection4;
    }
    ...
    getInfo () {
        return {
            ...
            blocks: [
                ...
                {
                    opcode: 'pubRecognition_time',
                    text: formatMessage({id: 'turtlebot.pubRecognition_time', default: '[RECOGNITION_TIME] 秒間聞き取る'}),
                    blockType: BlockType.COMMAND,
                    arguments: { RECOGNITION_TIME:{type: ArgumentType.ANGLE, defaultValue:formatMessage({id:'turtlebot.recognition_time',　default:'5'})}}
                },
                {
                ...
                {
                    opcode: 'subFingers_detection0',
                    text: formatMessage({ id: 'turtlebot.subFingers_detection0', default: '親指を立てている' }),
                    blockType: BlockType.BOOLEAN,
                    arguments: {}
                },
                {
                    opcode: 'subFingers_detection1',
                    text: formatMessage({ id: 'turtlebot.subFingers_detection1', default: '人差し指を立てている' }),
                    blockType: BlockType.BOOLEAN,
                    arguments: {}
                },
                {
                    opcode: 'subFingers_detection2',
                    text: formatMessage({ id: 'turtlebot.subFingers_detection2', default: '中指を立てている' }),
                    blockType: BlockType.BOOLEAN,
                    arguments: {}
                },
                {
                    opcode: 'subFingers_detection3',
                    text: formatMessage({ id: 'turtlebot.subFingers_detection3', default: '薬指を立てている' }),
                    blockType: BlockType.BOOLEAN,
                    arguments: {}
                },
                {
                    opcode: 'subFingers_detection4',
                    text: formatMessage({ id: 'turtlebot.subFingers_detection4', default: '小指を立てている' }),
                    blockType: BlockType.BOOLEAN,
                    arguments: {}
                }
            ],
